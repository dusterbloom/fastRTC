...
from backend.app.core.config import get_settings_instance
from backend.app.schemas.ws_schemas import (WSError, WSAuthRequest,
...
from backend.app.main import assistant_service_instance
