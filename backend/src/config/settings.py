...
class MemoryConfig:
    ...
    embedder_model: str = field(
        default_factory=lambda: os.getenv("AMEM_EMBEDDER_MODEL", "nomic-embed-text:latest")
    )
...
class DeploymentConfig:
    ...
    chroma_db_path: str = field(default_factory=lambda: os.getenv("CHROMA_DB_PATH", "backend/chroma_db"))
    models_path: str = field(default_factory=lambda: os.getenv("MODELS_PATH", "backend/models"))
...
AMEM_EMBEDDER_MODEL = "all-minilm"
