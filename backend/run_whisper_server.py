...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "-c",
        type=str,
        default=os.environ.get("FASTER_WHISPER_MODEL_PATH", "~/.cache/whisper-live/"),
    ...
    # Set HF_HOME environment variable for model caching if cache_path is provided
    if args.cache_path and args.cache_path != "~/.cache/whisper-live/":
        # Get the parent directory of the model path for HF_HOME
        cache_dir = os.path.dirname(os.path.dirname(args.cache_path))
