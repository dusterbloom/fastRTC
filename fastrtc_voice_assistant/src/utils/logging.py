...
COMPONENT_LOG_LEVELS: Dict[str, int] = {
    "fastrtc_voice_assistant.audio": logging.INFO,
    "fastrtc_voice_assistant.memory": logging.INFO,
    "fastrtc_voice_assistant.llm": logging.INFO,
    "fastrtc_voice_assistant.tts": logging.INFO,
    "fastrtc_voice_assistant.stt": logging.INFO,
    "fastrtc_voice_assistant.core": logging.INFO,
    "fastrtc_voice_assistant.integration": logging.INFO,
    # External libraries
...
class VoiceAssistantFilter(logging.Filter):
    ...
    def filter(self, record):
        ...
        if self.component:
            return record.name.startswith(f"fastrtc_voice_assistant.{self.component}")
        return record.name.startswith("fastrtc_voice_assistant")
...
def setup_logging(
    ...
    logger = logging.getLogger("fastrtc_voice_assistant.logging")
...
def create_session_logger(session_id: str) -> logging.Logger:
    ...
    """
    logger_name = f"fastrtc_voice_assistant.session.{session_id}"
...
def get_audio_logger() -> logging.Logger:
    ...
    return get_logger("fastrtc_voice_assistant.audio")


def get_memory_logger() -> logging.Logger:
    """Get logger for memory components."""
    return get_logger("fastrtc_voice_assistant.memory")


def get_llm_logger() -> logging.Logger:
    """Get logger for LLM components."""
    return get_logger("fastrtc_voice_assistant.llm")


def get_core_logger() -> logging.Logger:
    """Get logger for core components."""
    return get_logger("fastrtc_voice_assistant.core")